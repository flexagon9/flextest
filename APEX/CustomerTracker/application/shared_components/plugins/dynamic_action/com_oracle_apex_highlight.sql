--application/shared_components/plugins/dynamic_action/com_oracle_apex_highlight
 
begin
 
wwv_flow_api.create_plugin (
  p_id => 5389330606687795955 + wwv_flow_api.g_id_offset
 ...
 ,p_plsql_code => 
'-- The render function generates the necessary javascript code for the'||unistr('\000a')||
'-- dynamic action plug-in and registers this function with the dynamic action'||unistr('\000a')||
'-- client side framework.'||unistr('\000a')||
'-- The render function has a defined interface which every plug-in has to'||unistr('\000a')||
'-- implement. It''s designed in a way that future enhancements to the interface'||unistr('\000a')||
'-- will not break existing plug-ins.'||unistr('\000a')||
'function render_highlight ('||unistr('\000a')||
'    p_d'||
'ynamic_action in apex_plugin.t_dynamic_action,'||unistr('\000a')||
...
'            p_plug'||
'in         => p_plugin,'||unistr('\000a')||
'            p_dynamic_action => p_dynamic_action );'||unistr('\000a')||
'    end if;'||unistr('\000a')||
'    -- ***********************************'||unistr('\000a')||
'    -- Here starts the actual plug-in code'||unistr('\000a')||
'    -- ***********************************'||unistr('\000a')||
...
'    -- library is loaded when the plug-in is used mul'||
'tiple times on the page.'||unistr('\000a')||
'    -- If the developer stores the javascript file on the web-server, the'||unistr('\000a')||
'    -- p_plugin.file_prefix will contain the web-server URL. If the variable'||unistr('\000a')||
'    -- contains #PLUGIN_PREFIX#, the file will be read from the database.'||unistr('\000a')||
'    apex_javascript.add_library ('||unistr('\000a')||
'        p_name      => ''highlight'','||unistr('\000a')||
'        p_directory => p_plugin.file_prefix,'||unistr('\000a')||
'        p_version   => null );'||unistr('\000a')||
'    '||
'-- Register the javascript function which should be called when the plug-in'||unistr('\000a')||
'    -- action is executed with the APEX client side dynamic action framework.'||unistr('\000a')||
'    -- The javascript function can be a named javascript function, but it can'||unistr('\000a')||
'    -- also be an anonymous function if the code is really short.'||unistr('\000a')||
'    -- For example: function(){this.affectedElements.hide(this.action.attribute01);}'||unistr('\000a')||
'    l_result.java'||
'script_function := ''com_yourcompany_apex_highlight'';'||unistr('\000a')||
'    -- use the application level values if they are not set on instance level'||unistr('\000a')||
'    l_result.attribute_01        := coalesce(p_dynamic_action.attribute_01, p_plugin.attribute_01);'||unistr('\000a')||
'    l_result.attribute_02        := coalesce(p_dynamic_action.attribute_02, p_plugin.attribute_02);'||unistr('\000a')||
''||unistr('\000a')||
'    return l_result;'||unistr('\000a')||
'end render_highlight;'||unistr('\000a')||
''
 ,p_render_function => 'render_highlight'
 ,p_standard_attributes => 'ITEM:REGION:DOM_OBJECT:JQUERY_SELECTOR:REQUIRED'
...
wwv_flow_api.create_plugin_attribute (
  p_id => 5389331506472805396 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 5389330606687795955 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_attribute (
  p_id => 5389331823094810154 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 5389330606687795955 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291410564671685996 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389331823094810154 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 10
 ,p_display_value => 'Slow'
 ,p_return_value => 'slow'
  );
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291410671955685997 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389331823094810154 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 20
...
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291410792417685997 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389331823094810154 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_attribute (
  p_id => 5389332199807822413 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 5389330606687795955 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_attribute (
  p_id => 5389332517123827363 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 5389330606687795955 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'COMPONENT'
 ,p_attribute_sequence => 2
...
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291410881858685997 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389332517123827363 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 10
 ,p_display_value => 'Slow'
 ,p_return_value => 'slow'
  );
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291410979097685997 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389332517123827363 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 20
 ,p_display_value => 'Normal'
...
wwv_flow_api.create_plugin_attr_value (
  p_id => 5291411075234685997 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 5389332517123827363 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 30
 ,p_display_value => 'Fast'
...
wwv_flow_api.create_plugin_file (
  p_id => 5343249852224261669 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 5389330606687795955 + wwv_flow_api.g_id_offset
