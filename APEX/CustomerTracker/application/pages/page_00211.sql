...
prompt  ...PAGE 211: Sales by Product
--
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20130410111955'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1734052193374586657 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 211,
...
wwv_flow_api.create_flash_chart5(
  p_id                     => 1734052405958586659+wwv_flow_api.g_id_offset,
  p_flow_id                => wwv_flow.g_flow_id,
  p_page_id                => 211,
  p_region_id              => 1734052193374586657+wwv_flow_api.g_id_offset,
  ...
  p_display_attr           =>':H:N::Y::N::V:Y:None:::N:::Default:::',
  p_dial_tick_attr         =>':::::::::::',
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select p.rowid link, '||unistr('\000a')||
'       p.product_name||'' [$''||p.list_price||'']'' product,'||unistr('\000a')||
...
'group by p.rowid, p.product_id, p.product_name, p.list_price'||unistr('\000a')||
'order by p.product_name';

wwv_flow_api.create_flash_chart5_series(
  p_id                        => 1734052507117586659+wwv_flow_api.g_id_offset,
  p_chart_id                  => 1734052405958586659+wwv_flow_api.g_id_offset,
  p_flow_id                   => wwv_flow.g_flow_id,
  p_series_seq                =>10,
