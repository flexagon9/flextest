...
wwv_flow_api.create_page_plug (
  p_id=> 993463174629860278 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 7524442313226231365 + wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 994153049186344086 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_plug_name=> 'Reports',
  p_region_name=>'',
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 994151967736344085 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 1020551668298437577+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_query_row_template=> 1,
