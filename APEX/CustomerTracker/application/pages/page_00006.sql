...
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20130213084116'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 7699760403145959454 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 7400606324169391610 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Product Image',
  p_region_name=>'',
  p_parent_plug_id=>7699760403145959454 + wwv_flow_api.g_id_offset,
  p_escape_on_http_output=>'N',
  p_plug_template=> 1020542070938437571+ wwv_flow_api.g_id_offset,
...
'begin'||unistr('\000a')||
'  if :P6_PRODUCT_ID is not null then'||unistr('\000a')||
'    for c1 in (select nvl(dbms_lob.getlength(product_image),0) l'||unistr('\000a')||
'               from demo_product_info'||unistr('\000a')||
'               where product_id = :P6_PRODUCT_ID)'||unistr('\000a')||
'    loop'||unistr('\000a')||
'      if c1.l > 0 then'||unistr('\000a')||
...
wwv_flow_api.create_page_button(
  p_id             => 7400654920939882652 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 50,
  p_button_plug_id => 7400606324169391610+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 7699760700356959458 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 30,
  p_button_plug_id => 7699760403145959454+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_action  => 'SUBMIT',
...
wwv_flow_api.create_page_button(
  p_id             => 7699760896922959460 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
...
wwv_flow_api.create_page_button(
  p_id             => 7699760607052959457 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
...
wwv_flow_api.create_page_button(
  p_id             => 7699760800889959458 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
...
wwv_flow_api.create_page_branch(
  p_id=>7699760994888959463 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_branch_name=> '',
...
wwv_flow_api.create_page_item(
  p_id=>4168899712860993951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_TAGS',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 90,
  p_item_plug_id => 7699760403145959454+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4170114918183686488 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_BRANCH',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>7400605801397366148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>7400606122307381637 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_IMAGE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  p_item_plug_id => 7400606324169391610+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  ...
  p_field_template=> 7400090416218502974+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_escape_on_http_output => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>7699761111686959466 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>7699761215202959477 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>7699761427108959480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>7699761498992959480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_CATEGORY',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> '.'||to_char(7524915799174488797 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 31,
  p_cMaxlength=> 255,
...
begin
h := null;
h:=h||'Identify whether or not this product is currently available for orders.';

wwv_flow_api.create_page_item(
  p_id=>7699761718685959480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  ...
  p_named_lov=> 'Y OR N',
  p_lov=> '.'||to_char(7524568917136715135 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 2,
  p_cMaxlength=> 255,
...
begin
h := null;
h:=h||'This is the suggested retail price for the item, however, the price can be altered on each order.';

wwv_flow_api.create_page_item(
  p_id=>7699761797495959481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
wwv_flow_api.create_page_process(
  p_id     => 7699761904110959484 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'-- empty the image'||unistr('\000a')||
'update demo_product_info '||unistr('\000a')||
'set product_image = null,'||unistr('\000a')||
'mimetype = null,'||unistr('\000a')||
'filename=null,'||unistr('\000a')||
'image_last_update=null'||unistr('\000a')||
'where product_id = :P6_PRODUCT_ID;';

wwv_flow_api.create_page_process(
  p_id     => 7400655103193896444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  ...
  p_error_display_location=> 'ON_ERROR_PAGE',
  p_process_when_button_id=>7400654920939882652 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 7699762024187959485 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
