...
<report name="report1" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    ...
    <dataSource name="QP_1">
      <plugin
       factoryClass="oracle.reports.plugin.datasource.textpds.TextDataSourceFactory"
       majorVersionNumber="1" minorVersionNumber="2"
       signOnParameter="TEXT_HTTPS">
      <![CDATA[<textFilePDS DTDVersion="1.0">
<DataSource>https://gist.githubusercontent.com/mbostock/9535021/raw/60378dab56e8c222b69b53fa6a5deefd1b22743c/us-state-capitals.csv</DataSource><DataDefinition>Example Variable Width Comma Delimited</DataDefinition><select>
<element name = "var_cd_col1" type = "string" startpos = "25" width = "10"/><element name = "var_cd_col2" type = "string" startpos = "25" width = "10"/><element name = "var_cd_col3" type = "string" startpos = "25" width = "10"/></select>
</textFilePDS>]]>
      </plugin>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_var_cd_col1">
        <displayInfo x="1.26746" y="1.94995" width="1.46521" height="0.79956"
        />
        <dataItem name="var_cd_col1" datatype="character"
         javaDatatype="oraChar" columnOrder="12" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="var_cd_col1">
          <dataDescriptor expression="var_cd_col1"
           descriptiveExpression="var_cd_col1" order="1" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="var_cd_col2" datatype="character"
         javaDatatype="oraChar" columnOrder="13" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="var_cd_col2">
          <dataDescriptor expression="var_cd_col2"
           descriptiveExpression="var_cd_col2" order="2" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="var_cd_col3" datatype="character"
         javaDatatype="oraChar" columnOrder="14" defaultWidth="100000"
         defaultHeight="10000" columnFlags="33" defaultLabel="var_cd_col3">
          <dataDescriptor expression="var_cd_col3"
           descriptiveExpression="var_cd_col3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="Countvar_cd_col1PerReport" source="var_cd_col1"
  ...
  <section name="main">
    <body>
      <frame name="M_G_var_cd_col1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.50000" height="0.56250"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_var_cd_col1" source="G_var_cd_col1"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_var_cd_col1" source="var_cd_col1" minWidowLines="1"
          ...
          <field name="F_var_cd_col2" source="var_cd_col2" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_var_cd_col3" source="var_cd_col3" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
        ...
        <frame name="M_G_var_cd_col1_FTR">
          <geometryInfo x="0.00000" y="0.37500" width="4.50000"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_Countvar_cd_col1PerReport"
           source="Countvar_cd_col1PerReport" minWidowLines="1" spacing="0"
           alignment="start">
        ...
        <frame name="M_G_var_cd_col1_HDR">
          ...
          <text name="B_var_cd_col1" minWidowLines="1">
          ...
          <text name="B_var_cd_col2" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_var_cd_col3" minWidowLines="1">
            <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="4.04150" y="0.25000" width="0.41687" height="0.16675"
        />
        <textSegment>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwbeige" sectionTitle="Karl1"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGvarcdcol1GRPFR198">
<table class="OraTable">
<caption> Karl1 </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBvarcdcol1198" asArray="no"/> class="OraColumnHeader"> var_cd_col1 </th>
   <th <rw:id id="HBvarcdcol2198" asArray="no"/> class="OraColumnHeader"> var_cd_col2 </th>
   <th <rw:id id="HBvarcdcol3198" asArray="no"/> class="OraColumnHeader"> var_cd_col3 </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGvarcdcol11981" src="G_var_cd_col1">
   <tr>
    <td <rw:headers id="HFvarcdcol1198" src="HBvarcdcol1198"/> class="OraCellText"><rw:field id="Fvarcdcol1198" src="var_cd_col1" nullValue="&nbsp;"> F_var_cd_col1 </rw:field></td>
    <td <rw:headers id="HFvarcdcol2198" src="HBvarcdcol2198"/> class="OraCellText"><rw:field id="Fvarcdcol2198" src="var_cd_col2" nullValue="&nbsp;"> F_var_cd_col2 </rw:field></td>
    <td <rw:headers id="HFvarcdcol3198" src="HBvarcdcol3198"/> class="OraCellText"><rw:field id="Fvarcdcol3198" src="var_cd_col3" nullValue="&nbsp;"> F_var_cd_col3 </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 <!-- Report Level Summary -->
 <tr>
  <td <rw:headers id="HFCountvarcdcol1PerReport198" src="HBvarcdcol1198"/> class="OraTotalNumber">Count: <rw:field id="FCountvarcdcol1PerReport198" src="Countvar_cd_col1PerReport" nullValue="&nbsp;"> F_Countvar_cd_col1PerReport </rw:field></td>
